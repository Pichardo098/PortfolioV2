  ...
  return (
    <main id="info_personal" className='relative  w-full h-[200vh] flex flex-col justify-between '>
        <article  id='about_me' className='h-full flex flex-col relative justify-center items-end  max-w-[1200px] mx-auto' >
            <section className='w-[70%] z-10 grid gap-8 px-2 relative top-[-30px] min-[400px]:text-[20px]  '>
              <h2 className='font-bold text-[30px] md:text-[40px]' >Hi!</h2>
              ...
              <section className='text-white text-[30px]'>
                <ul className='flex justify-around '>
                  ...
                  <li className='md:text-[35px] md:before:text-[25px] relative before:content-["Tailwind"] before:absolute before:-translate-x-[60%] before:translate-y-[100%] before:text-[#FF2B51] before:text-[20px] before:mt-3 before:px-2 before:rounded-md before:bg-[#181818] before:invisible hover:before:visible '><i className='bx bxl-tailwind-css' ></i></li>
                </ul>
              </section>
            </section>
            <section className='absolute bottom-[20px] z-0 -translate-x-1/4 md:-translate-x-[35%]'>
        ...
        <article ref={refProyects} id='proyects' className='h-full flex flex-col relative  items-center justify-center max-w-[1200px] mx-auto'>
          <section className='w-[80%] z-10 flex flex-col  gap-8 px-2 relative '>
            ...
            <section className='w-full h-[400px] min-[390px]:h-[600px] min-[400px]:text-[20px] bg-white/30 rounded-xl p-4 overflow-scroll flex justify-center text-center md:text-[30px] md:h-[700px]'>
              ...
              <div className='grid gap-1 '>
                <img className=' rounded-[45px] mx-auto ' src="./proyects/rick_morty.png" alt="Página Web de Rick and Morty" />
              ...
              <hr />
              <div className='grid gap-1'>
                <img className='mx-auto ' src="./proyects/app_clima.png" alt="Página web del clima" />
              ...
              <hr />
              <div className='grid gap-1'>
                <img className=' rounded-[10px] mx-auto' src="./proyects/pokedex1.png" alt="Página web de Pokemon" />
          ...
          <section className='absolute bottom-[20px] -translate-x-1/4 '>
